...
{
    public class ReOrderViewComponent : ViewComponent
    {
        ...
        public ReOrderViewComponent(IGenericDal<Order> orderdal, IHttpContextAccessor httpContextAccessor, IGenericDal<CartItem> cartdal, IGenericDal<Product> productDal, IGenericDal<ApUser> apuserdal, IGenericDal<Address> adresdal, IGenericDal<ProductImages> pidal)
        {
            _orderdal = orderdal;
            _cartdal = cartdal;
