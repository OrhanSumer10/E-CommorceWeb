...
namespace ECommorceWeb.Controllers
{
    ...
    public class PaymentController : Controller
    {
        ...
        public PaymentController(IGenericDal<Product> productdal,IGenericDal<Address> adresdal, IGenericDal<CreditCard> ccdal, IGenericDal<CartItem> cidal, IGenericDal<ApUser> userdal, IGenericDal<Order> orderdal)
        {
            _adresdal = adresdal;
            _ccdal = ccdal;
            _cidal = cidal;
